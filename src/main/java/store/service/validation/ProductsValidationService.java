...
public class ProductsValidationService {
    ...
    private void validateProductInformationPrice(String rawPrice) {
        ValidationUtil.validateLong(rawPrice, new ProductsFileException(PRODUCTS_FILE_MAX_PRICE_EXCEPTION));
    }

    private void validateProductInformationQuantity(String rawQuantity) {
        ValidationUtil.validateLong(rawQuantity, new ProductsFileException(PRODUCTS_FILE_MAX_PRICE_EXCEPTION));
    }
